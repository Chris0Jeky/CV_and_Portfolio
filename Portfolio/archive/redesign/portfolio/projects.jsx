  ...
  return (
    <article style={{ borderTop: '1px solid var(--rule)', paddingTop: 32 }}>
      <FeatureHeader num="041" name="Taskdeck" cat="Local-first Devtool · Clean Architecture"
        years="2025 — active" team="solo · 4,500+ commits · 2,866+ tests · 17 ADRs" tone="forest"/>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.2fr', gap: 48 }}>
        <div>
          ...
          <p style={{ fontSize: 16, lineHeight: 1.65, color: 'var(--ink-2)' }}>
            ...
            authorisation. <strong>2,866+ tests</strong> total: 1,668 backend (incl. FsCheck
            property tests + fuzz tests), 1,174 frontend unit, 24 Playwright E2E, plus k6
            load profiles. CI ships CycloneDX SBOMs and SLSA provenance.
          </p>
          <p style={{ fontSize: 16, lineHeight: 1.65, color: 'var(--ink-2)' }}>
