...
const config = {"id":"portfolio","project":{"events":["page.view","app.ready","app.error","action.requested","action.completed","action.failed","duration.ms","project.opened","contact.requested"],"routes":["home","project","cv"],"releases":["unattributed"],"measurements":["duration.ms"]},"origin":"https://chris0jeky.github.io","endpoint":"","scopePath":"/CV_and_Portfolio/Portfolio/portfolio.html","release":"unattributed","route":"home","clicks":[]};
